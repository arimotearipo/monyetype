...
>(({ className, ...props }, ref) => (
  <MenubarPrimitive.Root
    ref={ref}
    className={cn(
      "flex h-9 items-center space-x-1 rounded-md border border-slate-200 bg-white p-1 shadow-xs dark:border-slate-800 dark:bg-slate-950",
      className,
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <MenubarPrimitive.Trigger
    ref={ref}
    className={cn(
      "flex cursor-default select-none items-center rounded-xs px-3 py-1 text-sm font-medium outline-hidden focus:bg-orange-600 focus:text-white data-[state=open]:bg-slate-100 data-[state=open]:text-slate-900 dark:focus:bg-slate-800 dark:focus:text-slate-50 dark:data-[state=open]:bg-slate-800 dark:data-[state=open]:text-slate-50",
      className,
    )}
    {...props}
  />
